...
<div style="display: flex; justify-content: space-between;">
  <img src="./2d1.png" alt="Performance Plot" width="31%">
  <img src="./2d2.png" alt="Performance Plot" width="31%">
  <img src="./2d3.png" alt="Performance Plot" width="31%">
</div>
...
<div style="display: flex; justify-content: space-between;">
  <img src="./3d1.png" alt="Performance Plot 1" width="31%">
  <img src="./3d2.png" alt="Performance Plot 2" width="31%">
</div>
